(function() {
  ...
  var inputNeighborhood = document.querySelector('input[id=neighborhoods-select]');
  var listboxNeighborhood = document.querySelector('div.listboxNeighborhood');

  var inputCuisine = document.querySelector('input[id=cuisines-select]');
  var listboxCuisine = document.querySelector('div.listboxCuisine');

  new ComboBox(inputNeighborhood, listboxNeighborhood);
  new ComboBox(inputCuisine, listboxCuisine);
})();
